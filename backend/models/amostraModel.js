// backend/models/amostraModel.js
...
const createAmostra = async (amostra) => {
    ...
    try {
      const result = await pool.query(
        'INSERT INTO amostras ( produto, lote, data_fabricacao, data_validade, quantidade, unidade, responsavel) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *',
